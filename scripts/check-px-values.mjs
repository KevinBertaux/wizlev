...
if (allIssues.length > 0) {
  console.error('Px value guard failed. Non-compliant px values detected:');
...
console.log(
  `Px value guard OK: ${allFiles.length} file(s) checked, all px values follow project rules.`
);
